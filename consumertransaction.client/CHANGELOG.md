...
- Create Angular project with ng: `ng new consumertransaction.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`consumertransaction.client.esproj`).
